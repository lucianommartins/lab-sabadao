# -*- coding: utf-8 -*-
# Vendored VERBATIM from CharXiv (github.com/princeton-nlp/CharXiv, src/constants.py)
# so grading is leaderboard-faithful. DO NOT edit the prompt strings.
# CharXiv: Wang et al., NeurIPS 2024 Datasets & Benchmarks (arXiv:2406.18521).
# Defines: DESCRIPTIVE_RESP_INST, DESCRIPTIVE_GRADING_PREFIX, DESCRIPTIVE_GRADING_QMAP,
#          DESCRIPTIVE_GRADING_ICL, REASONING_GRADING_PREFIX, REASONING_GRADING_INST,
#          REASONING_RESP_INST.
